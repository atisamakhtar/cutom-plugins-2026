  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
    ...
    <tr>
      <td style="background-color:#1d4ed8;padding:20px 32px;text-align:center;">
        ...
        <p style="margin:6px 0 0;font-size:13px;color:#bfdbfe;">Booking Reference: <strong>#</strong><strong>{booking_id}</strong></p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:20px 32px 0;">
        <p style="margin:0 0 12px;font-size:13px;font-weight:700;color:#1d4ed8;text-transform:uppercase;letter-spacing:0.8px;border-bottom:2px solid #1d4ed8;padding-bottom:6px;">Pick-Up Details</p>
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
          <tr>
    ...
    <tr>
      <td style="padding:20px 32px 0;">
        <p style="margin:0 0 12px;font-size:13px;font-weight:700;color:#1d4ed8;text-transform:uppercase;letter-spacing:0.8px;border-bottom:2px solid #1d4ed8;padding-bottom:6px;">Customer Contact Information</p>
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
          <tr>
    ...
    <tr>
      <td style="background-color:#111827;padding:14px 32px;text-align:center;">
        <p style="margin:0;font-size:12px;color:#6b7280;">
          © Optimus Fleets LLC · Admin Notification · Do not reply to this email
        </p>
      </td>
    </tr>
