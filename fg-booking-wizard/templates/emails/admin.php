          ...
          <tr>
            <td style="background-color:#111827;padding:28px 32px;text-align:center;">
              ...
              <a href="https://optimusfleets.us" target="_blank"
                style="display:block;text-decoration:none;line-height:0;background-color:#111827;margin-bottom:12px;">
              ...
              <p style="margin:0 0 6px;font-size:13px;font-weight:500;">
                <a href="tel:+18564433401" style="color:#FD8B48;text-decoration:none;">
                  856-443-3401
                </a>
              </p>
              ...
              <!-- Email -->
              <p style="margin:0 0 6px;font-size:13px;font-weight:500;">
                <a href="mailto:optimusfleetsllc@gmail.com" style="color:#FD8B48;text-decoration:none;">
                  optimusfleetsllc@gmail.com
                </a>
              </p>

              <!-- Website -->
              <p style="margin:0 0 8px;">
                <a href="https://www.optimusfleets.us"
                  target="_blank"
                  style="color:#FD8B48;text-decoration:none;font-size:14px;font-weight:600;">
                  www.optimusfleets.us
                </a>
              </p>
